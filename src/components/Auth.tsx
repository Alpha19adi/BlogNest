...
import { SignupInput } from "@aditya_agrawal/medium-common";
      ...
      <div className="flex justify-center">
        <div>
          <div className="px-10">
            ...
            <div className="text-slate-500 text-center mt-[2.5px]">
              {type === "signin"
          ...
          <div className="pt-4">
            ...
            <div className="flex justify-center">
            {wrongPass && (
              <div className="text-red-500 font-semibold fade-in-100 mt-4 ">
...
function LabelledInput({ label, placeholder, onChange, type }: LabelledInput) {
  return (
    <div>
      <label className="block mb-2 text-sm font-semibold text-gray-900 dark:text-black pt-3">
        {label}
      </label>
      <input
        onChange={onChange}
